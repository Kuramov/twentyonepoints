package ru.kuramov.health.repository;

import ru.kuramov.health.TwentyOnePointsApp;
import ru.kuramov.health.config.Constants;
import ru.kuramov.health.config.audit.AuditEventConverter;
import ru.kuramov.health.domain.PersistentAuditEvent;
...
import static ru.kuramov.health.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
